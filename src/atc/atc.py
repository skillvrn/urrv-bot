...
# --- Configuration ---
BOT_PREFIX = "/"
POSITION_ANNOUNCEMENT_CHANNEL_ID: Optional[int] = int(os.getenv('DISCORD_POSITION_ANNOUNCEMENT_CHANNEL_ID') or 0)
...
# --- Global Variables ---
monitored_positions: Dict[str, datetime.datetime] = {}  # {position: start_time}
...
async def monitor_positions():
    ...
    if POSITION_ANNOUNCEMENT_CHANNEL_ID: # Check if channel ID is set
        ...
        print("WARNING: POSITION_ANNOUNCEMENT_CHANNEL_ID not set, skipping position monitoring.")
