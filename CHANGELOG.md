...
## v0.2.5 - 2026/01/08
* Был полностью переписан функционал atc.py
* Исправлен Flake8

## v0.2.4 - 2025/10/11
* Код был отформатирован под Flake 8
* Исправлено упоминание роли "Курсанты" об проведении УТП

## v0.2.3 - 2025/08/25
* Исправлено упоминание роли "Курсанты" об УТП
